            ...
            <footer id="site-footer">
                <section className="horizontal-footer-section" id="footer-middle-section">
                    <div id="footer-about" className="footer-columns footer-columns-large">
                        <h1>Our Address</h1>
                        <address>
                            <p><img src="https://img.icons8.com/ios-filled/14/eeeeee/marker.png" />Loknathpur, Dalsinghsarai-848114, Samastipur, Bihar</p>
                            <p><img src="https://img.icons8.com/ios-filled/14/eeeeee/mail.png" />pksharma211@gmail.com</p>
                            <p><img src="https://img.icons8.com/ios-filled/14/eeeeee/phone.png" />9424824272</p>
                            <p><img src="https://img.icons8.com/ios-filled/14/eeeeee/clock.png" />9:00 AM – 5:00 PM</p>
                        </address>
                    ...
                    <div className="footer-columns">
                        ...
                        <ul className="footer-column-menu" role="menu">
                            <li className="footer-column-menu-item" role="menuitem">
                                <Link to="/about" className="footer-column-menu-item-link">About Us</Link>
                            </li>
                            <li className="footer-column-menu-item" role="menuitem">
                                <a href="#" className="footer-column-menu-item-link">Business with us</a>
                            </li>
